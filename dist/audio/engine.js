 ...
 * runs.
 */
function armUnlock(context) {
    if (disarmUnlock || typeof window === "undefined")
        return;
...
function tryResume(context, then) {
    try {
